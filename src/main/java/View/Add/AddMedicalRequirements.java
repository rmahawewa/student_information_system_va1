...
public class AddMedicalRequirements extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        topicLabel.setText("රෝග විස්තර ඇතුලත් කිරීම");

        deseaseNameLabel.setFont(new java.awt.Font("Iskoola Pota", 0, 14)); // NOI18N
        deseaseNameLabel.setText("රෝගයේ නම:");

        deseaseNameText.setFont(new java.awt.Font("Iskoola Pota", 0, 14)); // NOI18N
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if(!desease_name.equals("")){
            ...
            if(i > 0){
                ...
                rsm.setMessage("විශේෂ සෞඛ්‍ය අවශ්‍යතාවය පිලිබද තොරතුරු සාර්ථක ලෙස දත්ත පද්ධතියට සම්ප්‍රේෂණය විය");
                rsm.setVisible(true);
            }else{
                ...
                rem.setMessage("විශේෂ සෞඛ්‍ය අවශ්‍යතාවය පිලිබද තොරතුරු දත්ත පද්ධතියට එක් කිරීම අසාර්ථක බැවින් කරුණාකර නැවත උත්සහ කරන්න");
                rem.setVisible(true);
            }
        }else{
